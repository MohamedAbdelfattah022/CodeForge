...
namespace Codeforge.Infrastructure.Migrations
{
    ...
    [Migration("20250825192816_contests_and_standings")]
    partial class contests_and_standings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Codeforge.Domain.Entities.Contest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Codeforge.Domain.Entities.ProblemResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Codeforge.Domain.Entities.Standing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Codeforge.Domain.Entities.Problem", b =>
                {
                    b.HasOne("Codeforge.Domain.Entities.Contest", "Contest")
                        .WithMany("Problems")
            ...
            modelBuilder.Entity("Codeforge.Domain.Entities.ProblemResult", b =>
                {
                    b.HasOne("Codeforge.Domain.Entities.Standing", "Standing")
                        .WithMany("Problems")
            ...
            modelBuilder.Entity("ContestUser", b =>
                {
                    b.HasOne("Codeforge.Domain.Entities.Contest", null)
                        .WithMany()
